...
export default function MotionGenerator() {
    ...
    const [resultWithMedia, setResultWithMedia] = useState<MotionResultWithMedia | null>(null);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const scriptData = await generateMotion({ prompt });
