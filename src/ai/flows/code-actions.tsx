...
const mockProjects = [
    { id: 1, title: 'Projet Nébuleuse (Court-métrage)', imageUrl: 'https://picsum.photos/seed/nebula_project/300/200', hint: 'nebula space stars' },
    { id: 2, title: 'Lancement Marque de Vêtements', imageUrl: 'https://picsum.photos/seed/clothing_brand/300/200', hint: 'clothing brand fashion' },
    { id: 3, title: 'Identité Visuelle - Nova', imageUrl: 'https://picsum.photos/seed/nova_design/300/200', hint: 'abstract gradient design' },
];
