...
const LazyLightEnvApp = dynamic(() => import('@/components/light-env-app'));
...
export const ALL_APPS_CONFIG = [
    ...
    { id: 'light', name: '(X)Light', icon: Sparkles, component: (props: any) => <LazyLightEnvApp {...props} />, defaultPos: { x: 100, y: 150 }, defaultSize: { width: 900, height: 700 } },
    { id: 'inspire', name: '(X)Inspire', icon: Sparkles, component: (props: any) => <LazyInspireApp {...props} />, defaultPos: { x: 100, y: 100 }, defaultSize: { width: "100%", height: "100%" } },
