...
export const products: Product[] = [
  ...
  },
  {
    id: 11,
    name: "(X)bridge Pro",
    tagline: "Doublez la puissance, décuplez la créativité.",
    description: "Une station de travail conçue pour la performance multi-GPU ultime, avec deux cartes graphiques travaillant en tandem.",
    price: 6499.00,
    images: ["https://picsum.photos/seed/xbridgepro/800/800"],
    hint: "dual gpu computer",
    category: 'Matériel',
    isFeatured: true,
    configurable: false,
    hasPerformanceChart: true,
    features: ["Double NVIDIA RTX 4080 Super (48 Go VRAM totale)", "Processeur de pointe pour charges de travail extrêmes", "Refroidissement liquide optimisé pour deux GPU", "Idéal pour le rendu 3D, la simulation et l'IA"],
    specs: { "Carte graphique": "2x NVIDIA RTX 4080 Super (24 Go VRAM chacune)" },
  },
  {
    id: 12,
    name: "(X)bridge",
    tagline: "La puissance du multi-GPU accessible.",
    description: "Entrez dans le monde de la création multi-GPU avec une configuration équilibrée et performante.",
    price: 4999.00,
    images: ["https://picsum.photos/seed/xbridge/800/800"],
    hint: "dual gpu workstation",
    category: 'Matériel',
    isFeatured: false,
    configurable: false,
    hasPerformanceChart: true,
    features: ["Double NVIDIA RTX 4070 Ti Super (32 Go VRAM totale)", "Excellent rapport performance/prix pour le multi-GPU", "Parfait pour les créateurs 3D et les développeurs de jeux"],
    specs: { "Carte graphique": "2x NVIDIA RTX 4070 Ti Super (16 Go VRAM chacune)" },
  },
  {
    id: 2,
